 ...
 * @author meherzad
 */
public class ServletProjectFile extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletProjectFile</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletProjectFile at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String DESTINATION_DIR_PATH = getServletContext().getRealPath("/") + "images/projFile";
            ...
            while (itr1.hasNext()) {
                ...
                if (!item.isFormField()) {
                    ...
                    item.write(file);
                    db.updateprojectfile(userId, userId.toString() + ext);
